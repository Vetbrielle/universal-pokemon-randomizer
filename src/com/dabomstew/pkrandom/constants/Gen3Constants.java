...
public class Gen3Constants {
    ...
    public static void trainerTagsGaia(List<Trainer> trs) {
        // Gym Trainers
        tag(trs, "GYM1", 0x167, 0x169, 0x16C, 0x16D);
        tag(trs, "GYM2", 0x1E, 0x1F, 0x20, 0x21, 0x22);
        tag(trs, "GYM3", 0x41, 0x42, 0x43);
        tag(trs, "GYM4", 0x6A, 0x6B, 0x6C, 0x6D, 0x6E, 0x6F);
        tag(trs, "GYM5", 0x16E, 0x16F, 0x170, 0x171, 0x172, 0x173);
        tag(trs, "GYM6", 0x11B, 0x11C, 0x11D, 0x11E, 0x11F, 0x1A7, 0x1A8);
        tag(trs, "GYM7", 0x1, 0x2, 0x6, 0x8, 0x9);
        tag(trs, "GYM8", 0x200, 0x201, 0x202, 0x203, 0x204, 0x205);
